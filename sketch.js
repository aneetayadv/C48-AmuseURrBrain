...
function preload(){
  ...
  r11i = loadImage("assets/lion.png");
  r12i = loadImage("assets/killer.png");
  r13i = loadImage("assets/fire.png");
...
function setup() {
  ...
  //btnPlay.style("background-image: url('assets/musicOn.png');padding: 1px 1px 10px 1px;background-repeat: no-repeat;background-position: center;border: hidden;background: transparent;)");
  ...
  r13 = createSprite(width/1.2,height/4.5);
  r13.addImage(r13i);
  r13.scale = 0.5;
  r13.visible = false;
